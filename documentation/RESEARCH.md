...
| `collectKeyDetails` | Whether detailed keystroke categories should be collected (`keysLetter`, `keysNumber`, `keysNavigate`, etc.) in addition to totals. Keep disabled unless your study needs this higher granularity.                                                                                                              |                 | `false`       |
