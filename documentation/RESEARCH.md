...
| `questions`             | An array of questions that the participant should self-reflect on. You can define one or multiple questions within the array. By default, if the array consists of multiple questions, one question will be randomly selected for each prompt.                                                                                                                                                                                                                                                          | ✅               |                           |
