...
| `showAllQuestionsTogether` | When set to `true`, the experience sampling popup shows all configured questions stacked in their defined order and requires all answers before the participant can save. When set to `false`, one configured question is randomly selected for each prompt.                                                                                                                                                                                                                                           |                 | `false`                   |
