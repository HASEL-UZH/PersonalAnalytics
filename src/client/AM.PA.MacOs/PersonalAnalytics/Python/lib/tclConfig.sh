...
# installed.
TCL_PREFIX='/Users/csatterfield/repos/Python'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/csatterfield/repos/Python'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/csatterfield/repos/Python/include -fdebug-prefix-map=/usr/local/miniconda/conda-bld/tk_1574438129975/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/Users/csatterfield/repos/Python=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem /Users/csatterfield/repos/Python/include '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/csatterfield/repos/Python/lib -L/Users/csatterfield/repos/Python/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
TCL_RANLIB='/usr/local/miniconda/conda-bld/tk_1574438129975/_build_env/bin/x86_64-apple-darwin13.4.0-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/local/miniconda/conda-bld/tk_1574438129975/work/tcl8.6.10/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/csatterfield/repos/Python/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/csatterfield/repos/Python/include'
...
# compiled.
TCL_SRC_DIR='/usr/local/miniconda/conda-bld/tk_1574438129975/work/tcl8.6.10'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/Users/csatterfield/repos/Python/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/local/miniconda/conda-bld/tk_1574438129975/work/tcl8.6.10/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/csatterfield/repos/Python/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/local/miniconda/conda-bld/tk_1574438129975/work/tcl8.6.10/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/csatterfield/repos/Python/lib/libtclstub8.6.a'
