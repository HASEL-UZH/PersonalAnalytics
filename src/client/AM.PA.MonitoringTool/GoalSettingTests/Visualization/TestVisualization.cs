    ...
    public class TestVisualization
    {
        ...
        public void TestRetrospectionGoalSetting()
        {
            ...
            if (switchedToTestDB)
            {
                ...
                rules.Add(new GoalActivity { ID = new Guid(), Title = "Test Rule 5", IsVisualizationEnabled = true, Activity = ContextCategory.WorkUnrelatedBrowsing, TimeSpan = RuleTimeSpan.Hour, Rule = new Rule { Operator = GoalSetting.Model.RuleOperator.LessThan, TargetValue = "1", Goal = GoalSetting.Model.RuleGoal.NumberOfSwitchesTo } });
