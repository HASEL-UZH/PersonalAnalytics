...
namespace SlackTracker.AccessDataService {
    ...
    public interface IAccessData {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccessData/GetSlackClientId", ReplyAction="http://tempuri.org/IAccessData/GetSlackClientIdResponse")]
        string GetSlackClientId();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccessData/GetSlackClientId", ReplyAction="http://tempuri.org/IAccessData/GetSlackClientIdResponse")]
        System.Threading.Tasks.Task<string> GetSlackClientIdAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccessData/GetSlackClientSecret", ReplyAction="http://tempuri.org/IAccessData/GetSlackClientSecretResponse")]
        string GetSlackClientSecret();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccessData/GetSlackClientSecret", ReplyAction="http://tempuri.org/IAccessData/GetSlackClientSecretResponse")]
        System.Threading.Tasks.Task<string> GetSlackClientSecretAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccessDataChannel : SlackTracker.AccessDataService.IAccessData, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccessDataClient : System.ServiceModel.ClientBase<SlackTracker.AccessDataService.IAccessData>, SlackTracker.AccessDataService.IAccessData {
        ...
        public string GetSlackClientId() {
            return base.Channel.GetSlackClientId();
        }
        
        public System.Threading.Tasks.Task<string> GetSlackClientIdAsync() {
            return base.Channel.GetSlackClientIdAsync();
        }
        
        public string GetSlackClientSecret() {
            return base.Channel.GetSlackClientSecret();
        }
        
        public System.Threading.Tasks.Task<string> GetSlackClientSecretAsync() {
            return base.Channel.GetSlackClientSecretAsync();
        }
    }
}
