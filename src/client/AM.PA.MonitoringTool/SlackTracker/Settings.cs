...
namespace SlackTracker
{
    internal class Settings
    {
        ...
        internal const int SYNCHRONIZE_INTERVALL_FIRST = 10 * 60 * 1000; //10 minutes
        internal const int SYNCHRONIZE_INTERVALL_SECOND = 30 * 60 * 1000; //30 minutes
        ...
        internal static readonly string REGISTRATION_URL = "https://slack.com/oauth/authorize?client_id=12830536055.392728377956&redirect_uri=https%3A%2F%2Fgithub.com%2Fsealuzh%2FPersonalAnalytics&scope=channels:history%20channels:read";
