...
namespace Shared
{
    public static class Settings
    {
        ...
        public static TimeSpan RemindToResumeToolInterval = TimeSpan.FromSeconds(5); // TimeSpan.FromMinutes(30); // every 30 minutes, check if the tool is still paused, if yes: remind the user
