...
namespace WindowsActivityTracker.Helpers
{
    ...
    public static class ProcessToActivityMapper
    {
        ...
        private static readonly List<string> InstantMessagingAppsAndKeywords = new List<string> { "slack", "teams", "skype", "lync", "wechat", "sip", "g2mlauncher", "ciscowebexstart", "nbrplay", "g2mui", "chatter", "atmgr", "hangout", "viber", "messaging", "whatsapp", "messenger" }; // includes skype for business
