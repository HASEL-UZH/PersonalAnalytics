...
namespace WindowsActivityTracker.Helpers
{
    ...
    public static class ProcessToActivityMapper
    {
        ...
        private static readonly List<string> CodingApps = new List<string> { "rstudio", "sdv", "webplatforminstaller", "xts", "build", "cleardescribe", "clearfindco", "alm-client", "ildasm", "ssms", "mintty", "xming", "clearprojexp", "clearmrgman", "kitty", "bc2", "bcompare", "mobaxterm", "webmatrix", "mexplore", "linqpad", "android sdk manager", "windows phone application deployment", "ilspy", "tortoiseproc", "xsd", "eclipse", "javaw", "fiddler", "xamarin", "netbeans", "intellij", "sql", "sqlitebrowser", "devenv", "visual studio", "code", "vs_enterprise", "vs2013", "microsoftazuretools", "webstorm", "phpstorm", "source insight", "zend", "console", "powershell", "shell", "cmd", "tasktop", "android studio", "ide", "filezilla", "flashfxp", "charles" };
        ...
        private static readonly List<string> CodingDebugAppsAndKeywords = new List<string> { "xde", "debug", "bugger", "windbg", "perfview", "cdb", "msmunittest", "bug" }; // works for visual studio, eclipse (if view changes)
        ...
        private static readonly List<string> PlanningAppsAndKeywords = new List<string> { "backlog", "winproj", "trello", "wunderlist", "time tracking", "track time", "sap", "rescuetime", "clearquest", "scrum", "kanban", "codealike", "jira", "rally", "versionone", "calendar", "kalender", "sprint", "user story", "plan", "task", "aufgabe", "vorgangsliste", "work item" };
        ...
        private static readonly List<string> InstantMessagingAppsAndKeywords = new List<string> { "slack", "skype", "lync", "wechat", "sip", "g2mlauncher", "ciscowebexstart", "nbrplay", "g2mui", "chatter", "atmgr", "hangout", "viber", "messaging" }; // includes skype for business
        ...
        private static readonly List<string> OtherKeywords = new List<string> { "mmc", "dfsvc", "procmon64", "mousewithoutboarders", "vpnui", "dinotify", "perfmon", "agentransack", "lockapp", "searchui", "pwsafe", "personalanalytics", "wuauclt", "calc", "zip", "googleearth", "rar", "wwahost", "update", "avpui", "procexp64", "taskmgr", "pgp", "explorer", "groove", "dwm", "rstrui", "snippingtool", "onedrive", "settings", "einstellungen" };
