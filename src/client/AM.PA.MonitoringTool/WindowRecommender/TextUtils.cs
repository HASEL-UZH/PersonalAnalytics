...
namespace WindowRecommender
{
    internal static class TextUtils
    {
        ...
        private static readonly StemmerBase Stemmer = new EnglishStemmer();
        private static readonly Regex TitleRegex = new Regex(@"[^A-Za-zÀ-ÖØ-öø-ÿ'-]", RegexOptions.IgnoreCase | RegexOptions.Compiled);

        internal static IEnumerable<string> PrepareTitle(string windowTitle)
        {
