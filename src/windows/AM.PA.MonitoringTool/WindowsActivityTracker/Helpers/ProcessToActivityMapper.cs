...
namespace WindowsActivityTracker.Helpers
{
    ...
    public static class ProcessToActivityMapper
    {
        ...
        private static readonly List<string> InstantMessagingAppsAndKeywords = new List<string> { "teams", "signal", "slack", "skype", "lync", "wechat", "sip", "g2mlauncher", "ciscowebexstart", "nbrplay", "g2mui", "chatter", "atmgr", "hangout", "viber", "messaging", "whatsapp", "messenger" }; // includes skype for business

        private static readonly List<string> BrowserApps = new List<string> { "iexplore", "chrome", "firefox", "opera", "safari", "applicationframehost", "msedge", "edge" }; // ApplicationFrameHost stands for Edge
